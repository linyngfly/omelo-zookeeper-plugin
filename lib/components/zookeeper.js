...
var zookeeper = require('../../node_modules/node-zookeeper-client');
var CreateMode = zookeeper.CreateMode;
var logger = require('./node_modules/omelo-logger').getLogger('omelo-zookeeper-plugin', __filename);
...
var Component = function(app, opts) {
  ...
  this.path = opts.path || '/omelo/servers';
  this.username = opts.username || 'omelo';
  this.password = opts.password || 'omelo';
